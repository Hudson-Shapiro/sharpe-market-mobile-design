      ...
      */}
      <div className="relative z-10 p-3 max-w-md mx-auto pb-16">
        ...
        <div className="text-center mb-3 pt-2">
          ...
          <p className="text-muted-foreground text-xs">Detailed allocation insights & metrics.</p>
        </div>
        ...
        <div className="bg-card/50 border border-border/40 backdrop-blur-sm p-2.5 mb-2.5 rounded-xl">
          ...
          <div className="grid grid-cols-3 gap-1.5 text-center">
            <div className="p-1.5 bg-background/40 rounded-xl">
        ...
        {/* Recent Allocation Shifts - Compact with rounded edges */}
        <div className="bg-card/50 border border-border/40 backdrop-blur-sm mb-2.5 rounded-xl">
          <div className="p-2.5 pb-1">
            <h2 className="font-bold text-xs mb-1.5 flex items-center gap-1.5">
              ...
              <span className="text-xs bg-blue-500/20 text-blue-400 px-1.5 py-0.5 font-medium rounded-xl">1h</span>
            </h2>
          </div>
          <div className="px-2.5 pb-2.5 space-y-1">
            {[
              ...
              <div key={i} className="flex items-center justify-between p-1.5 bg-background/40 rounded-xl">
