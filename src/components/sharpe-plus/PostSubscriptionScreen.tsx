...
const PostSubscriptionScreen = () => {
  ...
  return (
    <div className="min-h-screen bg-transparent relative overflow-hidden">
      ...
      */}
      <div className="relative z-10 p-6 max-w-md mx-auto pb-20">
        {/* Header */}
        ...
        {/* Platform Summary */}
        <div className="bg-card/50 border border-border/40 backdrop-blur-sm p-4 mb-4 rounded-xl">
          <div className="flex items-center justify-between mb-3">
            <h2 className="font-bold text-base flex items-center gap-2">
              📊 Platform Summary
              <span className="text-xs bg-emerald-500/20 text-emerald-400 px-2 py-1 font-medium animate-pulse rounded-lg">Live</span>
            </h2>
          </div>
        ...
        <div className="bg-card/50 border border-border/40 backdrop-blur-sm mb-4 rounded-xl">
          <div className="p-4 pb-2">
            <h2 className="font-bold text-base mb-3 flex items-center gap-2">
              🔁 Recent Allocation Shifts
              <span className="text-xs bg-blue-500/20 text-blue-400 px-2 py-1 font-medium rounded-lg">1h</span>
            </h2>
          </div>
          <div className="px-4 pb-4 space-y-2">
            {[
              ...
              <div key={i} className="flex items-center justify-between p-3 bg-background/40 rounded-lg">
        ...
        <div className="bg-card/40 border border-border/40 backdrop-blur-sm rounded-xl">
          ...
          <div className="px-4 pb-4 space-y-2">
            <div className="p-3 bg-background/40 rounded-lg">
              <h4 className="font-medium text-sm mb-1">📊 Allocation Trends</h4>
              <p className="text-xs text-muted-foreground">Tech average allocation up 0.8% this week, with NVDA leading at 12.3% avg</p>
            </div>
            <div className="p-3 bg-background/40 rounded-lg">
              <h4 className="font-medium text-sm mb-1">⚡ Portfolio Penetration</h4>
