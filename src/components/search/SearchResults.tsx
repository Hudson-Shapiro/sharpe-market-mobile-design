...
const SearchResults = ({ searchQuery, searchFilter, filterVisible, setFilterVisible }: SearchResultsProps) => {
  ...
  // Filter component with improved scrolling
  const FilterComponent = () => (
    <div className="bg-background text-foreground h-full flex flex-col">
      ...
      <div className="p-4 grid grid-cols-2 gap-3 border-t border-border flex-shrink-0">
        <Button 
          variant="outline" 
  ...
  return (
    <div className="w-full">
      ...
      {/* Filter Drawer with improved height and scrolling */}
