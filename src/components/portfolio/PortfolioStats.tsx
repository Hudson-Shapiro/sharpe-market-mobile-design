    ...
    <>
      ...
      <div className="grid grid-cols-2 gap-4 mb-4">
        <div className="bg-gray-900/70 backdrop-blur-sm border border-gray-800/60 p-4 shadow-lg shadow-blue-500/5" style={{ borderRadius: '12px' }}>
          ...
          <div className="flex items-center text-emerald-400 text-sm font-semibold bg-emerald-500/10 w-fit px-2 py-1 border border-emerald-500/20 shadow-lg shadow-emerald-500/10" style={{ borderRadius: '12px' }}>
